...
public class Question implements Serializable {
	...
	public Question(int id_Question, String choix1, String choix2, String choix3, String choix4, int correcte,
			String question, Typeq typeqBean, List<Reponse> reponses) {
		super();
	...
	public Question(String choix1, String choix2, String choix3, String choix4, int correcte, String question,
			Typeq typeqBean, List<Reponse> reponses) {
		super();
		this.choix1 = choix1;
		this.choix2 = choix2;
		this.choix3 = choix3;
